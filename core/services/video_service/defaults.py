...
SMART_PRESETS = {
    "wan_2_6": {
        "quick": {"resolution": "480p", "fps": 15, "sampling_steps": 30, "cfg_scale": 7.0},
        "standard": {"resolution": "720p", "fps": 24, "sampling_steps": 50, "cfg_scale": 7.0},
        "cinematic": {"resolution": "1080p", "fps": 30, "sampling_steps": 75, "cfg_scale": 8.0}
    },
    "seedance-1.5-pro": {
        "quick": {"resolution": "480p", "fps": 15, "sampling_steps": 20, "cfg_scale": 6.5},
        "standard": {"resolution": "720p", "fps": 24, "sampling_steps": 40, "cfg_scale": 7.0},
        "cinematic": {"resolution": "1080p", "fps": 30, "sampling_steps": 60, "cfg_scale": 7.5}
    }
}
